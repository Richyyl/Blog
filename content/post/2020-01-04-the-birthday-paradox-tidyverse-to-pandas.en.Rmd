...
In order to stay away from dataframes I replied heavily on lists, with the first function taking an integer in order to provide a random sample on birthdays. This sample was then converted into a set in order to remove duplicates and a length check used to see if any items had been removed, giving me a binary output. 

The second function then acted to replicate this function for both a number of iterations and a range of people, giving me a final list of tuples with the people, trial and result which I could feed into a pandas dataframe and aggregate, as shown below. 
...
def birthday_trial(people):
  """Function that takes an integer of people and determines if at leas two have matching birthdays"""
