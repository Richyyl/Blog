...
```{r Test team scraping functions, eval = FALSE}
...
```{r Make team scraping function and url list, eval = FALSE}
...
```{r Test player scraping functions and make url list, eval = FALSE}
...
```{r Scrape player data, eval = FALSE}
...
```{r Scrape players clubs, eval = FALSE}
