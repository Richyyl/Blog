...
```{r Load team data and reproduce models}
...
```{r Build up teams for predictions}
...
```{r Boostrap model process for a goal distribution}
...
```{r Check distributions of two teams}
