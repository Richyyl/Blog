...
```{r Load team data, warning=FALSE, message=FALSE}
...
```{r Check passing stats, warning=FALSE, message=FALSE}
...
```{r Check chances, warning=FALSE, message=FALSE}
...
```{r Check tackles, warning=FALSE, message=FALSE}
...
```{r Check saves per goal, warning=FALSE, message=FALSE}
...
```{r Prep the data, warning=FALSE, message=FALSE}
...
```{r Make the model objects, warning=FALSE, message=FALSE}
...
```{r Fit the models, warning=FALSE, message=FALSE}
...
```{r make predictions and calculate error, warning=FALSE, message=FALSE}
...
```{r Extract error and plot, warning=FALSE, message=FALSE}
...
```{r Produce variable importance plot for rf models, warning=FALSE, message=FALSE}
...
```{r Attempt ridge regression and compare to lm, warning=FALSE, message=FALSE}
...
```{r Fit the final LM model and run on the test data, eval = FALSE}
