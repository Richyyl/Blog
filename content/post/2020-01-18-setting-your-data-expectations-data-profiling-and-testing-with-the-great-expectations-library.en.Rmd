...
generator = ge.datasource.generator.databricks_generator.DatabricksTableGenerator(name = 'default', datasource = None, database = DATABASE)

data_assets = generator.get_available_data_asset_names()

data_assets_paths = ["spark/passthrough/" + i for i in data_assets]
