...
As such, I decided to take some inspiration from two tutorials, the first relating to structural topic models ![silge](https://juliasilge.com/blog/sherlock-holmes-stm/) and the second a full text analysis of the GoT novels ![GOT](https://api.rpubs.com/julheimer/got)
